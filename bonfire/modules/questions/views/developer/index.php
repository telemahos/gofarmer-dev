<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Questions.Developer.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Questions.Developer.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/developer/questions/edit/'. $record->q_id, '<i class="icon-pencil">&nbsp;</i>' .  $record->question_id) ?></td>
				<?php else: ?>
