<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			<thead>
				<tr>
					<?php if ($this->auth->has_permission('Questions.Settings.Delete') && isset($records) && is_array($records) && count($records)) : ?>
			...
			<tfoot>
				<?php if ($this->auth->has_permission('Questions.Settings.Delete')) : ?>
				<tr>
					<td colspan="14">
			...
			<?php foreach ($records as $record) : ?>
				...
				<?php if ($this->auth->has_permission('Questions.Settings.Edit')) : ?>
				<td><?php echo anchor(SITE_AREA .'/settings/questions/edit/'. $record->q_id, '<i class="icon-pencil">&nbsp;</i>' .  $record->question_id) ?></td>
				<?php else: ?>
