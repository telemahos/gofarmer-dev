...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create Questions" />
            or <?php echo anchor(SITE_AREA .'/settings/questions', lang('questions_cancel'), 'class="btn btn-warning"'); ?>
