...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Questions.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Questions.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_questions())
			{
				...
				Template::redirect(SITE_AREA .'/developer/questions');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/questions');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Questions.Developer.Edit');
		...
		{
			$this->auth->restrict('Questions.Developer.Delete');
