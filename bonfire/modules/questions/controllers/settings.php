...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Questions.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Questions.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_questions())
			{
				...
				Template::redirect(SITE_AREA .'/settings/questions');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/questions');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Questions.Settings.Edit');
		...
		{
			$this->auth->restrict('Questions.Settings.Delete');
