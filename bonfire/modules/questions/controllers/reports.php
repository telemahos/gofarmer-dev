...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Questions.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Questions.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_questions())
			{
				...
				Template::redirect(SITE_AREA .'/reports/questions');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/questions');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Questions.Reports.Edit');
		...
		{
			$this->auth->restrict('Questions.Reports.Delete');
