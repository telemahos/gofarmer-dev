...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Starter.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Starter.Reports.Create');
	...
	*/
	...
	{
		$this->auth->restrict('Starter.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/starter');
		}
	...
	*/
	...
	{
		$this->auth->restrict('Starter.Reports.Delete');
