...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Wizard.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Wizard.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_wizard())
			{
				...
				redirect(SITE_AREA .'/settings/wizard');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Wizard.Settings.Edit');
		...
		{
			$this->auth->restrict('Wizard.Settings.Delete');
