...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Wizard.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Wizard.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_wizard())
			{
				...
				redirect(SITE_AREA .'/reports/wizard');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Wizard.Reports.Edit');
		...
		{
			$this->auth->restrict('Wizard.Reports.Delete');
