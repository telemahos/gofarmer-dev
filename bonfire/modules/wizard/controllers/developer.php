...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Wizard.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Wizard.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_wizard())
			{
				...
				redirect(SITE_AREA .'/developer/wizard');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Wizard.Developer.Edit');
		...
		{
			$this->auth->restrict('Wizard.Developer.Delete');
