				...
				<div class='well'>
					...
					<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
						...
						<div class="control-group <?php echo form_error('comp_name') ? 'error' : ''; ?>">
					        <?php echo form_label("Επονυμία Επιχείρησης", 'comp_name', array('class' => "control-label") ); ?>
					        <div class='controls'>
					    ...
					    <div class="control-group <?php echo form_error('comp_description') ? 'error' : ''; ?>">
					        <?php echo form_label("Περιγραφή Επιχείρησης", 'comp_description', array('class' => "control-label") ); ?>
					        <div class='controls'>
					        	<textarea id="comp_description" name="comp_description">
					        		<?php echo set_value('comp_description', isset($gfusers->comp_description) ? $gfusers->comp_name : ''); ?>
					        	</textarea>
							    <!-- <input id="comp_description" type="text" name="comp_description" maxlength="255" value="<?php //echo set_value('comp_description', isset($gfusers->comp_description) ? $gfusers->comp_name : ''); ?>"  /> -->
							    <span class="help-inline"><?php echo form_error('comp_description'); ?></span>
						    </div>
					    </div>
					    <hr>
						<div class="control-group <?php echo form_error('name') ? 'error' : ''; ?>">
					        <?php echo form_label("Το όνομα σας", 'name', array('class' => "control-label") ); ?>
					        <div class='controls'>
					    ...
					    <div class="control-group <?php echo form_error('last_name') ? 'error' : ''; ?>">
					        <?php echo form_label("Το επίθετο σας", 'last_name', array('class' => "control-label") ); ?>
					        <div class='controls'>
					    ...
					    <!-- <div class="form-actions"> -->
					        ...
					        <?php echo anchor('wizard/wizard_buix/wizard_buix_two',  'Παράβλεψη', 'class=""'); ?>&nbsp;&nbsp;
