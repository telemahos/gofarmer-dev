	...
	<div class='SPAN12'>
		...
		<div class='span6 offset3'>
			<div class='well'>
				...
				?>
				<div class="">
				    <h3>Ζήτηση Προϊόντων<?php // echo lang('croffer_title') ?></h3>
				    <p>Δημιουργήστε μια ή περισσότερες ζητήσεις προϊόντων, για να σας βρούνε περισσότεροι παραγωγοί στο GoFarmer.</p>
