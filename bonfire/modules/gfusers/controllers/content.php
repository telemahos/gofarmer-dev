...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gfusers.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Gfusers.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_gfusers())
			{
				...
				Template::redirect(SITE_AREA .'/content/gfusers');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/gfusers');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gfusers.Content.Edit');
		...
		{
			$this->auth->restrict('Gfusers.Content.Delete');
