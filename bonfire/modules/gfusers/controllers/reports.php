...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Gfusers.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Gfusers.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_gfusers())
			{
				...
				Template::redirect(SITE_AREA .'/reports/gfusers');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/gfusers');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Gfusers.Reports.Edit');
		...
		{
			$this->auth->restrict('Gfusers.Reports.Delete');
