...
<?php $options = array(
        ...
        <div class="form-actions">
            ...
            or <?php echo anchor(SITE_AREA .'/content/crop', lang('crop_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Crop.Content.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/content/crop/delete/'. $id);?>" onclick="return confirm('<?php echo lang('crop_delete_confirm'); ?>')" name="delete-me">
