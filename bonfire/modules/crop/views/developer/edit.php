...
<?php $options = array(
    ...
    <?php if ($this->auth->has_permission('Crop.Developer.Delete')) : ?>
            ...
            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/developer/crop/delete/'. $id);?>" onclick="return confirm('<?php echo lang('crop_delete_confirm'); ?>')" name="delete-me">
