...
<?php $options = array(
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="submit" class="btn btn-primary" value="Edit crop" />
            or <?php echo anchor(SITE_AREA .'/settings/crop', lang('crop_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Crop.Settings.Delete')) : ?>

            or <a class="btn btn-danger" id="delete-me" href="<?php echo site_url(SITE_AREA .'/settings/crop/delete/'. $id);?>" onclick="return confirm('<?php echo lang('crop_delete_confirm'); ?>')" name="delete-me">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('crop_delete_record'); ?>
            </a>
