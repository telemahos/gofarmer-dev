      ...
      <fieldset>
        <legend></legend>
          ...
          <div class="control-group">
            ...
            <div class='controls'>
              <div class="input-append">
                <input id="hectar" type="text" name="hectar" maxlength="10" value="<?php if(isset($crop['hectar'])) : echo $crop['hectar']; endif; ?>" placeholder='Αριθμός σε στρέμματα' /><span class="add-on">Στρ.</span>
              </div>
          ...
          <div class="control-group">
            ...
            <div class='controls'>
              <textarea id="comment" name="comment" placeholder='Σχόλιο' rows="5"><?php if(isset($crop['comment'])) : echo $crop['comment']; endif; ?>
              </textarea>
        ...
        <div class="form-actions">
              <input type="submit" id='crop_sumbit_up' name="submit" class="btn btn-primary"  value="Αποθήκευση" />
