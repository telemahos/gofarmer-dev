...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Crop.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Crop.Content.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_crop())
			{
				...
				Template::redirect(SITE_AREA .'/content/crop');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('Crop.Content.Delete');
