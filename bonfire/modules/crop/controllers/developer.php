...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Crop.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Crop.Developer.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_crop())
			{
				...
				Template::redirect(SITE_AREA .'/developer/crop');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('Crop.Developer.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/crop');
		}
	...
	*/
	...
	{
		$this->auth->restrict('Crop.Developer.Delete');
