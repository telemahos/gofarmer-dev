...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Crop.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Crop.Reports.Create');
		...
		if ($this->input->post('submit'))
		{
			if ($insert_id = $this->save_crop())
			{
				...
				Template::redirect(SITE_AREA .'/reports/crop');
			}
			else
			{
	...
	*/
	...
	{
		$this->auth->restrict('Crop.Reports.Edit');
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/crop');
		}
	...
	*/
	...
	{
		$this->auth->restrict('Crop.Reports.Delete');
