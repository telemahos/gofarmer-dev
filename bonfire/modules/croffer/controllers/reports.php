...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Croffer.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Croffer.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_croffer())
			{
				...
				Template::redirect(SITE_AREA .'/reports/croffer');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/croffer');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Croffer.Reports.Edit');
		...
		{
			$this->auth->restrict('Croffer.Reports.Delete');
