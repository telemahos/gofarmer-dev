...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Croffer.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Croffer.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_croffer())
			{
				...
				Template::redirect(SITE_AREA .'/developer/croffer');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/croffer');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Croffer.Developer.Edit');
		...
		{
			$this->auth->restrict('Croffer.Developer.Delete');
