...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Create Messages" />
            or <?php echo anchor(SITE_AREA .'/developer/messages', lang('messages_cancel'), 'class="btn btn-warning"'); ?>
