...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Messages.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Messages.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_messages())
			{
				...
				Template::redirect(SITE_AREA .'/reports/messages');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/messages');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Messages.Reports.Edit');
		...
		{
			$this->auth->restrict('Messages.Reports.Delete');
