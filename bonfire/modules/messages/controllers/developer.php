...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Messages.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Messages.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_messages())
			{
				...
				Template::redirect(SITE_AREA .'/developer/messages');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/messages');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Messages.Developer.Edit');
		...
		{
			$this->auth->restrict('Messages.Developer.Delete');
