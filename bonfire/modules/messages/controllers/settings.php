...
class settings extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Messages.Settings.View');
	...
	*/
	...
	{
		$this->auth->restrict('Messages.Settings.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_messages())
			{
				...
				Template::redirect(SITE_AREA .'/settings/messages');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/settings/messages');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Messages.Settings.Edit');
		...
		{
			$this->auth->restrict('Messages.Settings.Delete');
