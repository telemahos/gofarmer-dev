...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Edit crdemand" />
            or <?php echo anchor(SITE_AREA .'/settings/crdemand', lang('crdemand_cancel'), 'class="btn btn-warning"'); ?>
            

    <?php if ($this->auth->has_permission('Crdemand.Settings.Delete')) : ?>

            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php echo lang('crdemand_delete_confirm'); ?>')">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('crdemand_delete_record'); ?>
            </button>
