...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Crdemand.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Crdemand.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_crdemand())
			{
				...
				Template::redirect(SITE_AREA .'/content/crdemand');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/content/crdemand');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Crdemand.Content.Edit');
		...
		{
			$this->auth->restrict('Crdemand.Content.Delete');
