...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Crdemand.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Crdemand.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_crdemand())
			{
				...
				Template::redirect(SITE_AREA .'/developer/crdemand');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/developer/crdemand');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Crdemand.Developer.Edit');
		...
		{
			$this->auth->restrict('Crdemand.Developer.Delete');
