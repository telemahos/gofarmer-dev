...
class modules extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Crdemand.Modules.View');
	...
	*/
	...
	{
		$this->auth->restrict('Crdemand.Modules.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_crdemand())
			{
				...
				Template::redirect(SITE_AREA .'/modules/crdemand');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/modules/crdemand');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Crdemand.Modules.Edit');
		...
		{
			$this->auth->restrict('Crdemand.Modules.Delete');
