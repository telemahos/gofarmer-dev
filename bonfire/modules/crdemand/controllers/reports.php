...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Crdemand.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Crdemand.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_crdemand())
			{
				...
				Template::redirect(SITE_AREA .'/reports/crdemand');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (empty($id))
		{
			...
			redirect(SITE_AREA .'/reports/crdemand');
		}

		if (isset($_POST['save']))
		{
			$this->auth->restrict('Crdemand.Reports.Edit');
		...
		{
			$this->auth->restrict('Crdemand.Reports.Delete');
