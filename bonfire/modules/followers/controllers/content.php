...
class content extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Followers.Content.View');
	...
	*/
	...
	{
		$this->auth->restrict('Followers.Content.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_followers())
			{
				...
				redirect(SITE_AREA .'/content/followers');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Followers.Content.Edit');
		...
		{
			$this->auth->restrict('Followers.Content.Delete');
