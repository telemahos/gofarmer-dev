...
class developer extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Followers.Developer.View');
	...
	*/
	...
	{
		$this->auth->restrict('Followers.Developer.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_followers())
			{
				...
				redirect(SITE_AREA .'/developer/followers');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Followers.Developer.Edit');
		...
		{
			$this->auth->restrict('Followers.Developer.Delete');
