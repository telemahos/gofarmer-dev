...
class reports extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Followers.Reports.View');
	...
	*/
	...
	{
		$this->auth->restrict('Followers.Reports.Create');
		...
		if ($this->input->post('save'))
		{
			if ($insert_id = $this->save_followers())
			{
				...
				redirect(SITE_AREA .'/reports/followers');
			}
			else
			{
	...
	*/
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Followers.Reports.Edit');
		...
		{
			$this->auth->restrict('Followers.Reports.Delete');
