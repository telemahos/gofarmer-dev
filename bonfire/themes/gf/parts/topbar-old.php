<div class="navbar navbar-fixed-top">
	<div class="navbar-inner">
	    ...
	    <div class="container">
			...
			<a href="<?php echo base_url(); ?>" class="brand" title="GoFarmer"><img src="<?php echo base_url('assets/images/tractor-x04.png'); ?>"  width='40' height='40' class="">&nbsp;Go<span>Farmer</span></a>
					...
					<form class="pull-right">
		                <div class="input-append">
		                  <div class="btn-toolbar" style="margin: 0;">
		                    <div class="btn-group">
		                      <input class="input-large" id="appendedInputButton" placeholder='Αναζήτηση' type="text">
		                      <button class="btn" type="submit"><i class="icon-search"></i></button>
		                      <button class="btn dropdown-toggle " data-toggle="dropdown">
		                        <span class="caret"></span>
		                      </button>
		                      <ul class="dropdown-menu pull-right">
		                        <li><a href="#">Παραγωγών</a></li>
		                        <li><a href="#">Εταιριών</a></li>
		                        <li><a href="#">Μελών</a></li>
		                        <li class="divider"></li>
		                        <li><a href="#">Προσφορές</a></li>
		                        <li><a href="#">Ζήτησεις</a></li>
		                        <li><a href="#">Αγγελίες</a></li>
		                        <li><a href="#">Ομάδες</a></li>
